<section class="ps-timeline-sec">
        <div class="container">
            <ol class="ps-timeline wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
                <li>
                    <div class="img-handler-top">
                        <img src="http://wwa.physology.co.uk/wp-content/uploads/2016/02/ps-elem_03.png" alt=""/>
                    </div>
                    <div class="ps-bot">
